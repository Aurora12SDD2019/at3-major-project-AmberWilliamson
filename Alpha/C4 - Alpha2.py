...
DIFFICULTY = 1 #how many moves ahead the AI will look before determining it's move, 0-2 only or the game will not run
...
start = pygame.time.get_ticks() #time since pygame started in millisecs
score = 0
