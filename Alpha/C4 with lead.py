...
DIFFICULTY = 2 #how many moves ahead the AI will look before determining it's move, 0-2 only or the game will not run
...
def main():
    ...
    SONGS = ['sound/do_do_do.ogg', 'sound/new_hope.ogg', 'sound/dragon_shores.ogg', 'sound/mystic_marsh.ogg', 'sound/crystal_glacier.ogg']
    ...
    score = pygame.time.get_ticks()/1000 #time in seconds
    print(score)
...
def runGame(isFirstGame):
    if isFirstGame:
        ...
        if random.randint(0, 1) == 0:
            ...
            turn = PLAYER
        showHelp = False #every restart will not have the tutorial in it

    mainBoard = getNewBoard() #gets a fresh new board when restarted
